...
=======================================================
Script:
  It is used to create views for the Gold Layer in Data Warehouse.
  The Gold layer represents the final Dimension and Fact Tables (Star Schema)
  Each view performs transformation and combines data from Silver layer to produce a clean and business ready dataset
