...
=======================================================
The stored procedure performs ETL (Extract, Transform, Load) process to 
populate the 'silver' schema tables from 'bronze' schema
Actions performed includes:
  - Truncate silver tables
  - Insert transformed and cleaned data from 'bronze' into 'silver' tables
The stored prcedure accepts no parameters or return any values
Use: EXEC silver.load_silver
*/

--==================================================
-- Create Stored Procedure (Build Silver Layer)
--===================================================
